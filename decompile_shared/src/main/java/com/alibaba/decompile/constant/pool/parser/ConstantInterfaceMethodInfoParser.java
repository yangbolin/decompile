...
public class ConstantInterfaceMethodInfoParser implements ConstantInfoParser {
    ...
    public ConstantInfo parse(ByteCodeContext byteCodeContext) {
        ...
        int interfaceIndex = Integer.valueOf(ByteUtils.bytesToHex(interfaceIndexBytes), DecompileConstants.HEX_RADIX);
        ...
        int descriptor = Integer.valueOf(ByteUtils.bytesToHex(descriptorBytes), DecompileConstants.HEX_RADIX);
