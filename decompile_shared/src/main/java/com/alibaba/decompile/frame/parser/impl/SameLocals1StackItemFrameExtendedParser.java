...
import com.alibaba.decompile.frame.SameLocals1StackItemFrameExtended;
...
/**
 * @author yangbolin Jan 26, 2013 3:37:40 PM
 */
public class SameLocals1StackItemFrameExtendedParser implements FrameParser {

    private static final String NAME = "same_locals_1_stack_item_frame_extended";

    @Override
    public SMTPFrame parse(ByteCodeContext byteCodeContext, DecompileFactory decompileFactory, int type) {
        SameLocals1StackItemFrameExtended frame = new SameLocals1StackItemFrameExtended();
        frame.setType(type);
        frame.setName(NAME);
