...
import com.alibaba.decompile.frame.info.UninitializedThisVariableInfo;
import com.alibaba.decompile.frame.info.VerificationTypeInfo;
import com.alibaba.decompile.frame.parser.TypeInfoParser;

/**
 * @author yangbolin Jan 26, 2013 2:40:42 PM
 */
public class UninitializedThisVariableInfoParser implements TypeInfoParser {

    private static final String NAME = "uninitializedThis";
    @Override
    public VerificationTypeInfo parse(ByteCodeContext byteCodeContext, DecompileFactory decompileFactory) {
        UninitializedThisVariableInfo typeInfo = new UninitializedThisVariableInfo();
